...
def command1():
    exec(open(r"C:\Users\Admin\Desktop\pong\extras\game choice.py").read(), globals())
def login_ver():
...
def main_screen():
    ...
    Label(text="Python Game By Ajai and Ajay",bg="green",width ="300",height="1",font=("Ariel",15)).pack()
    Label(text=" ").pack()
